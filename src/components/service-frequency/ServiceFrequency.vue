...
import IndividualDayManager from './controls/IndividualDayManager.vue'
import TimeWindowsManager from './controls/TimeWindowsManager.vue'
import ExactTimeManager from './controls/ExactTimeManager.vue'
